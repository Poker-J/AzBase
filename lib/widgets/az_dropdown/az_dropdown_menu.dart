...
class AzDropdownMenuBuilder {
  final Widget dropDownWidget;
  final double dropDownHeight;

  AzDropdownMenuBuilder({@required this.dropDownWidget, @required this.dropDownHeight});
}

typedef DropdownMenuChange = void Function(bool isShow, int index);

class AzDropDownMenu extends StatefulWidget {
  final AzDropdownMenuController controller;
  final List<AzDropdownMenuBuilder> menus;
  ...
  @override
  _AzDropDownMenuState createState() => _AzDropDownMenuState();
}

class _AzDropDownMenuState extends State<AzDropDownMenu> with SingleTickerProviderStateMixin {
  ...
  _onController() {
//    print('_AzDropDownMenuState._onController ${widget.controller.menuIndex}');
...
//    print('_AzDropDownMenuState.build');
...
//          color: widget.maskColor,
  ...
  Widget _buildDropDownWidget() {
    ...
    return Positioned(
        width: MediaQuery.of(context).size.width,
        top:  widget.controller.dropDownHeaderHeight  != null ? widget.controller.dropDownHeaderHeight - 1 :widget.controller.dropDownHeaderHeight,
        left: 0,
        child: Column(
          children: <Widget>[
            Container(
